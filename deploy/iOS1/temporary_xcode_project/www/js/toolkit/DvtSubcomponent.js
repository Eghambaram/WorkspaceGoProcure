...
DvtPanelDrawer.prototype.getMaxContentWidth = function() {
  return this._maxWidth - (2 * this.getContentPadding() + DvtScrollableContainer.DEFAULT_ALTA_SCROLLBAR_WIDTH + DvtPanelDrawer._SCROLLBAR_CONTENT_PADDING);
};
...
DvtPanelDrawer.prototype.getMaxContentHeight = function() {
  return this._maxHeight - (2 * this.getContentPadding() + DvtScrollableContainer.DEFAULT_ALTA_SCROLLBAR_WIDTH + DvtPanelDrawer._SCROLLBAR_CONTENT_PADDING);
};
...
DvtPanelDrawer.prototype.DisplayPanel = function(id, anim, onEnd) {
  if (!this._expandedContent) {
    ...
    var maxWidth = (this._maxWidth == Number.MAX_VALUE) ? null : this._maxWidth - 2 * this.getContentPadding();
    var maxHeight = (this._maxHeight == Number.MAX_VALUE) ? null : this._maxHeight - 2 * this.getContentPadding();
    ...
    this._expandedContentPanel.setTranslateX(this.getContentPadding());
    this._expandedContentPanel.setTranslateY(this.getContentPadding());
  }
...
DvtPanelDrawer.prototype.RefreshExpandedSize = function(id, anim) {
  ...
  var yy = 0;
  if (panel) {
    var dims = this._expandedContentPanel.getDimensionsWithStroke();
...
//
// $Header: dsstools/modules/dvt-shared-js/src/META-INF/bi/sharedJS/toolkit/adfinternal/subcomponent/DvtAccordionDefaults.js /bibeans_root/4 2014/04/10 10:38:33 nbalatsk Exp $
//
