...
DvtSunburst.prototype.OnAnimationEnd = function() {
  ...
  // Fix for 18598442: Force full angle extent in case the display animation didn't complete
...
DvtSunburstNode.prototype.GetAnimationParams = function(endState) {
  ...
  // Bug 16582576 - JS SUNBURST: ROTATION ANIMATION NOT CONSISTENT
...
DvtSunburstNode.prototype._createShapeNode = function() {
  ...
  var nodeDefaults = this._view.getOptions()['nodeDefaults'];
  shape.setStroke(new DvtSolidStroke(nodeDefaults['borderColor'], 0.3));
...
DvtSunburstNode.prototype._createTextNode = function(container) {
  ...
  // Bug 20464014: If this is the root node, and the angleExtent is not the full circle, then skip.
