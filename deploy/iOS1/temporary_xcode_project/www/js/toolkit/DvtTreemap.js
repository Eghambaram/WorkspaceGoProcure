...
/** @const @private **/
DvtTreemap._MIN_BUFFER_SPACE = 2; // Minimum buffer for very small treemaps
...
DvtTreemap.prototype.Init = function(context, callback, callbackObj) {
  ...
  // Make sure the object has an id for accessibility bug 20745395
...
DvtTreemap.prototype.Layout = function(availSpace) {
  ...
  var bufferSpace = Math.max(Math.ceil(DvtTreemap._BUFFER_SPACE * Math.min(availSpace.w, availSpace.h) / 400), DvtTreemap._MIN_BUFFER_SPACE);
...
var DvtTreemapNode = function(treemap, props) {
  ...
  // TODO HZHANG Switch to determining dynamically, which involves changing how isolate/restore is handled
