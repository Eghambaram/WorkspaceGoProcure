...
(function(){
  ...
  AttributeGroupManager.getSharedAttribute = function(discriminant, attributeName) {
    if(AttributeGroupManager['_sharedAttributes'][discriminant]) return AttributeGroupManager['_sharedAttributes'][discriminant][attributeName];
    return null;
  };
  ...
  AttributeGroupManager.addSharedAttribute = function(discriminant, attributeName, value) {
    ...
    if(!sharedAttributes) sharedAttributes = {};
...
(function ()
{
  ...
  BaseRenderer.prototype.findAmxNodeById = function (root, clientId)
  {
    var itemNode = null;
    if (clientId)
    {
...
/**
  ...
  */ 
  ...
  BaseComponentRenderer.prototype.MergeComponentOptions = function (amxNode)
  {
    ...
    amxNode['_optionsObj'] = adf.mf.internal.dvt.util.JSONUtils.mergeObjects(styleJSON, options);
  };
  ...
  BaseComponentRenderer.prototype.SetComponentDimensions = function (simpleNode, amxNode)
  {
    ...
    if (!computed)
    {
      ...
      // this has not colide with the smart layout behavior
      else if (DOMUtils.getHeight(simpleNode) < height)
      {
  ...
  BaseComponentRenderer.prototype.GetParentResizeCallback = function ()
  {
    if (!this._parentResizeCallback)
    {
      this._parentResizeCallback = function (event)
      {
        ...
        if (!simpleNode || !amxNode[adf.mf.internal.dvt.INSTANCE])
        {
        ...
        var dimensions = self.SetComponentDimensions(simpleNode, amxNode);
  ...
  BaseComponentRenderer.prototype.DestroyComponent = function (simpleNode, amxNode)
  {
    ...
    delete amxNode[adf.mf.internal.dvt.INSTANCE];
  };
   ...
   */
  adf.mf.internal.dvt.setOptionsDirty = function (amxNode, value)
  {
    if (value)
    {
      amxNode.setAttributeResolvedValue('_optionsDirty', true);
    }
    else 
    {
      amxNode.setAttributeResolvedValue('_optionsDirty', false);
    }
  };
  ...
  {
    if (amxNode.getAttribute('_optionsDirty'))
    {
      return true;
    }
    return false;
...
(function ()
{
  ...
  DataStampRenderer.prototype.postDisplay = function (rootElement, amxNode)
  {
    if ("yes" == amxNode.getAttribute("_placeholder"))
    {
      ...
      {
        this.SetComponentDimensions(rootElement, amxNode);
      }
...
(function(){
  ...
  BaseChartRenderer.prototype.InitComponentOptions = function (amxNode)
  {
    ...
    amxNode["_optionsObj"]["type"] = this.GetChartType();
    ...
    {
      amxNode['_optionsObj']['_locale'] = locale;
    }
  ...
  BaseChartRenderer.prototype.ResetComponentOptions = function (amxNode, attributeChanges, descendentChanges)
  {
    ...
    if (attributeChanges.getSize() > 0 || descendentChanges)
    {
      ...
      if (amxNode['_optionsObj']['legend']) {
        delete amxNode['_optionsObj']['legend']['sections'];
      }

      delete amxNode['_optionsObj']['valueFormats'];
        ...
        'callback' : function (event, component)
          {
            ...
            if (event.getType() === 'selection')
            {
              ...
              if (selection !== undefined)
              {
                ...
                {
                  rowKey = null;
                  var objId = item.getId ? item.getId() : item['id'];
                ...
                var selectedRowKeys = selection.map(rkMapper);

                var userSelection = amxNode.getAttribute("_selection") || [];
                userSelection = userSelection.map(rkMapper);
...
(function(){
  ...
  BaseTreeviewRenderer.prototype.setSelectedAndIsolatedNodes = function(amxNode) 
  {
    ...
    if (!amxNode.getAttribute("_selection"))
    {
      amxNode.setAttributeResolvedValue("_selection", selectedRowKeys);
    }

    if (isolatedRowKey || (selectedRowKeys && selectedRowKeys.length > 0)) 
    {
      var treeviewNodeTags = amxNode.getTag().getChildren(adf.mf.api.amx.AmxTag.NAMESPACE_DVTM, this.GetStampedChildTagName());
      ...
      else 
      {
        ...
        if (value)
        {
          ...
          while (iter.hasNext())
          {
            ...
            changed = changed | this._processIsolatedAndSelectedNodesForRowKey(
                    amxNode, isolatedRowKey, selectedRowKeys, iter.getRowKey());
  ...
  BaseTreeviewRenderer.prototype.ResetComponentOptions = function (amxNode, attributeChanges, descendentChanges)
  {
    ...
    AttributeGroupManager.reset(amxNode);
    if (amxNode["_optionsObj"]["selection"])
    {
      amxNode["_optionsObj"]["selection"] = null;
    }
    if (amxNode["_optionsObj"]["selectedNodes"])
    {
      amxNode["_optionsObj"]["selectedNodes"] = null;
    }
  };
        ...
        'callback' : function (event, component)
          {
            if (event.getType() === 'selection')
            {
              ...
              if (selection !== undefined)
              {
                ...
                {
                  var itemNode = renderer.findAmxNodeById(amxNode, selection[i]);
  ...
  BaseTreeviewNodeRenderer.prototype.ProcessAttributes = function (options, treeviewNode, context)
  {
    ...
    if(dataItem)
    {
      ...
      if(context["selectedRowKeys"] && context["selectedRowKeys"].indexOf(context['_rowKey']) > -1)
      {
        ...
        options["selection"].push(dataItem['id']);
      }
 ...
 (function ()
{
  ...
  ChartDataItemRenderer.prototype.ProcessAttributes = function (options, markerNode, context)
  {
    ...
    amxNode['_rowKeyCache'][dataItem['id']] = context['_rowKey'];
    ...
    var series = adf.mf.internal.dvt.chart.SeriesHelper.getSeriesByIdAndName(this._chartType, amxNode, seriesId, seriesName === null ? "" : seriesName);
    var groupIndex = this._addGroup(amxNode, groupId, group);
...
(function()
{
  ...
  SeriesStyleRenderer.prototype.ProcessAttributes = function (options, seriesStyleNode, context)
  {
    ...
    var ser = adf.mf.internal.dvt.chart.SeriesHelper.getSeriesByIdAndName(this._chartType, context['amxNode'], seriesId, seriesName);
 ...
 (function ()
{
  ...
  {    
    ...
    if (group) {
      var groupIndex = this._addGroup(amxNode, group);
      series['items'][groupIndex] = dataItem;
    } else {
      series['items'][series['items'].length] = dataItem;
    }
   ...
   */
  StockDataItemRenderer.prototype._addGroup = function (amxNode, group)
  {
    var groups = amxNode['_optionsObj']['groups'];
    var g;
...
(function(){
  ...
  adf.mf.internal.dvt.setThematicMapLayerProperties = function(type, amxNode, layerNode)
  {
    ...
    if (layerNode.isAttributeDefined('layer'))
    {
      ...
      if (!options['source'])
        adf.mf.internal.dvt.loadMapLayerAndResource(amxNode, options['basemap'], layer['layer']);
    }
    else
    {
      layer['layer'] = 'cities';
...
(function(){
  ...
  AreaLayerRendererDT.prototype.ProcessAttributes = function (options, layerNode, context)
  {
    ...
    // load resource and base map layer 
    adf.mf.internal.dvt.loadMapLayerAndResource(null, options['basemap'], layer['layer']); 
    options['areaLayers'].push(layer);
    return false;
  }    
...
(function(){
  ...
  PointDataLayerRenderer.prototype.ProcessAttributes = function (options, pointDataLayerNode, context)
  {
    ...
    if (!amxNode["_optionsObj"]['source'] && loadCityLayer)
      adf.mf.internal.dvt.loadMapLayerAndResource(amxNode, amxNode["_optionsObj"]['basemap'], 'cities');
...
(function(){
  ...
  LegendRenderer.prototype.GetAttributesDefinition = function ()
  {
    ...
    attrs['maxSize'] = {'path' : 'legend/maxSize', 'type' : AttributeProcessor['TEXT']};
    attrs['size'] = {'path' : 'legend/size', 'type' : AttributeProcessor['TEXT']};
...
(function(){
  ...
  RatingGaugeRenderer.prototype.GetStyleClassesDefinition = function ()
  {
    ...
    styleClasses['dvtm-ratingGaugeSelected'] = [
      ...
      {'path' : 'selectedState/borderColor', 'type' : StyleProcessor['TOP_BORDER'], 'overwrite' : false}
    ];
    styleClasses['dvtm-ratingGaugeUnselected'] = [
      {'path' : 'unselectedState/color', 'type' : StyleProcessor['COLOR'], 'overwrite' : false}, 
      {'path' : 'unselectedState/borderColor', 'type' : StyleProcessor['TOP_BORDER'], 'overwrite' : false}
    ];
    styleClasses['dvtm-ratingGaugeHover'] = [
      {'path' : 'hoverState/color', 'type' : StyleProcessor['COLOR'], 'overwrite' : false}, 
      {'path' : 'hoverState/borderColor', 'type' : StyleProcessor['TOP_BORDER'], 'overwrite' : false}];
    styleClasses['dvtm-ratingGaugeChanged'] = [
      {'path' : 'changedState/color', 'type' : StyleProcessor['COLOR'], 'overwrite' : false}, 
      {'path' : 'changedState/borderColor', 'type' : StyleProcessor['TOP_BORDER'], 'overwrite' : false}
    ];
    return styleClasses; 
  }  
...
(function ()
{
  ...
  GeographicMapRenderer.prototype.ProcessAttributes = function (options, amxNode, context)
  {
    ...
    amxNode["_optionsObj"]['mapOptions']['hasMapInputActionListener'] = amxNode.isAttributeDefined('mapInputListener');
    amxNode["_optionsObj"]['mapOptions']['hasMapBoundsChangeActionListener'] = amxNode.isAttributeDefined('mapBoundsChangeListener');
    ...
    var mapCallbackObj = 
    {
      'callback' : function (event, component)
      {
        ...
        if (type === DvtGeoMapSelectionEvent.TYPE)
        {
          ...
          if (dataLayerId)
          {
            itemNode = renderer.findAmxNodeById(amxNode, dataLayerId);
          ...
          else
          {
            ...
            {
              itemNode = renderer.findAmxNodeById(amxNode, dlId);
        ...
        {
          itemNode = renderer.findAmxNodeById(amxNode, event.getClientId());
  ...
  {
    return adf.mf.internal.dvt.geomap.DvtGeographicMap.newInstance(callback, callbackObj, amxNode['_optionsObj']);
  };
...
(function()
{
  ...
  DvtGeographicMapRenderer.renderOracleMap = function(map, mapCanvas, width, height) {
    ...
    {
      mapview.attachEventListener(MVEvent.MOUSE_CLICK, function() { clickHandler('click') });
      mapview.attachEventListener(MVEvent.MOUSE_DOWN, function() { clickHandler('mousedown') });
      mapview.attachEventListener(MVEvent.MOUSE_UP, function() { clickHandler('mouseup') });
    }
    // set the data layer
  ...
  DvtGeographicMapRenderer.addPointFOI = function(map, mapview, point, pointId, params) {
    ...
    if (selMode == DvtGeographicMapRenderer.SEL_SINGLE || selMode == DvtGeographicMapRenderer.SEL_MULTIPLE) {
      if (!amx.hasTouch()) {   // bug 18113730: do not register hover listeners on touch devices
    ...
    if (action) {
      pointFOI.attachEventListener(MVEvent.MOUSE_CLICK, function() {
        ...
        if (mbr && geom)
        {
          ...
          actionEvent.addParam('pointXY', { 'x': pixelX, 'y': pixelY });
          // report lat/long in 8307 coordinate system
          var callback = function(transGeom)
          {
            actionEvent.addParam('latLng', { 'lat': transGeom.getPointY(), 'lng': transGeom.getPointX() });
  ...
  DvtGeographicMapRenderer.googleMapRenderRoutes = function (map, gmap, data, initialZooming)
  {
    ...
    data.routes.forEach(
      function (routeOptions)
      {
        ...
        var polyOptions = {
          strokeColor : routeStyle['color'] || '#1fb5fb', 
          strokeOpacity : routeStyle['opacity'] || 1, 
          strokeWeight : routeStyle['width'] || 8
        };
        ...
        directionsService.route(request, function (result, status)
        {
          ...
          var createClickHandler = function(clientId, action)
          {
            return function (e)
            {
              ...
              actionEvent.addParam('pointXY', { 'x': pointXY.x, 'y': pointXY.y });
              actionEvent.addParam('latLng', { 'lat': clickPosition.lat(), 'lng': clickPosition.lng() });
  ...
  DvtGeographicMapRenderer.googleMapRenderEnd = function(gmap, map, points)
  {
    ...
    if (geocoderQueue.length > 0)
    {
      ...
      var callback = function(markerParams, aAddress, animation) {
        return function(results, status) 
        {
          ...
          {
            geocoderQueue.push({ 'resolved' : false, 'address' : aAddress, 'params' : markerParams, 'animation' : animation, 'initialZooming' : false });
          }
        }
      };
      ...
      setTimeout(function(geocoderCallback, renderer, queue) {
        ...
        var consumer = window.setInterval(function() {
          ...
          if (geo)
          {
            ...
            {
              geocoder.geocode({ 'address' : address }, geocoderCallback(geo['params'], address, geo['animation']));
            }
          }
    ...
    if (map._firstTime)
    {
      ...
      var fireMapBoundsChangeEvent = function()
      {
        ...
        var evt = new DvtMapBoundsChangeEvent(bounds.getSouthWest().lng(), bounds.getSouthWest().lat(),
                                              bounds.getNorthEast().lng(), bounds.getNorthEast().lat(),
                                              bounds.getCenter().lng(), bounds.getCenter().lat(), zoomLevel);
        map.__dispatchEvent(evt);
      };
      ...
      {
        google.maps.event.addListener(gmap, 'click', function(event) { clickHandler('click', event); });
        google.maps.event.addListener(gmap, 'mousemove', function(event) { mouseMoveHandler(event) });
        google.maps.event.addDomListener(gmap.getDiv(), 'mousedown', function(event) { domEventHandler('mousedown'); });
        google.maps.event.addDomListener(gmap.getDiv(), 'mouseup', function(event) { domEventHandler('mouseup'); });
      }
    ...
    for (var i = 0; i < dataLayers.length; i++)
    {
      ...
      for (var j = 0; j < points.length; j++)
      {
        ...
        if (points[j]['x'] && points[j]['y'])
        {
          ...
          result[index] = { 'resolved' : true, 'latLng' : markerLatLng, 'params' : params, 'animation' : animation, 'initialZooming' : initialZooming };
        ...
        else if (points[j]['address'])
        {
          ...
          if (cachedPoint)
          {
            result[index] = { 'resolved' : true, 'address' : address, 'latLng' : cachedPoint, 'params' : params, 'animation' : animation, 'initialZooming' : initialZooming };
            map._jobCount--;   // map point resolved
          }
          else
          {
            ...
            var callback = function(map, markerParams, aIndex, aAddress) {
              return function(results, status) 
              {
                ...
                if (status == google.maps.GeocoderStatus.OK)
                {
                  ...
                  result[aIndex] = { 'resolved' : true, 'address' : aAddress, 'latLng' : addrMarkerLatLng, 'params' : markerParams, 'animation' : animation, 'initialZooming' : initialZooming };
                }
  
                if (status == google.maps.GeocoderStatus.OVER_QUERY_LIMIT)
                {
                  result[aIndex] = { 'resolved' : false, 'address' : aAddress, 'params' : markerParams, 'animation' : animation, 'initialZooming' : initialZooming };
                }
            ...
            if (geocoderRequestCount < 10)
            {
              ...
              geocoder.geocode({ 'address' : address }, callback(map, params, index, address));
            }
            else
            {
              map._jobCount--;
              result[index] = { 'resolved' : false, 'address' : address, 'params' : params, 'animation' : animation, 'initialZooming' : initialZooming };
            }
          }
        }
        index++;
  ...
  DvtGeographicMapRenderer.addMarker = function(map, gmap, markerLatLng, params, animation) 
  {
    ...
    if (action) {
      google.maps.event.addListener(marker, DvtGeographicMapRenderer.CLICK, function() {
        ...
        actionEvent.addParam('pointXY', { 'x': pointXY.x, 'y': pointXY.y });
        actionEvent.addParam('latLng', { 'lat': markerPos.lat(), 'lng': markerPos.lng() });
        map.__dispatchEvent(actionEvent);
      });
    }
  };
...
(function() {
  ...
  NBoxNodeRenderer.prototype.ProcessArrayItem = function(options, nodeNode, context)
  {
    ...
    //  nodeNode.getAttribute("labelStyle");
 ...
 */(function ()
{
  ...
  NBoxRenderer.prototype.GetAttributesDefinition = function ()
  {
    ...
    attrs['animationOnDataChange'] = 
    {
      'path' : 'animationOnDataChange', 'type' : AttributeProcessor['TEXT']
    };
    attrs['animationOnDisplay'] = 
    {
      'path' : 'animationOnDisplay', 'type' : AttributeProcessor['TEXT']
    };
    attrs['columnsTitle'] = 
    {
      'path' : 'columnsTitle', 'type' : AttributeProcessor['TEXT']
    };
    //      attrs['columnsTitleStyle'] = {'path' : 'columnsTitle/style', 'type' : AttributeProcessor['TEXT']};
    attrs['emptyText'] = 
    {
      'path' : 'emptyText', 'type' : AttributeProcessor['TEXT']
    };
    attrs['groupBy'] = 
    {
    ...
    attrs['selectedRowKeys'] = 
    {
      'path' : 'selection', 'type' : PROP_ROW_KEYS
    };
   ...
   NBoxRenderer.prototype.ProcessAttributes = function (options, amxNode, context)
  {
    ...
    if (!amxNode.getAttribute("_selection"))
    {
      amxNode.setAttributeResolvedValue("_selection", AttributeProcessor['ROWKEYARRAY'](amxNode.getAttribute('selectedRowKeys')));
    }
    ...
    var callbackObject = 
    {
      'callback' : function (event, component)
      {
        ...
        if (type === DvtActionEvent.TYPE)
        {
          ...
          var itemNode = renderer.findAmxNodeById(amxNode, commandId);
  ...
  NBoxRenderer.prototype.ResetComponentOptions = function (amxNode, attributeChanges, descendentChanges)
  {
    ...
    if (amxNode["_optionsObj"])
    {
      delete amxNode["_optionsObj"]["cells"];
      delete amxNode["_optionsObj"]["columns"];
      delete amxNode["_optionsObj"]["rows"];
      
      if (!attributeChanges || attributeChanges.hasChanged('value') || descendentChanges)
      {
        delete amxNode["_optionsObj"]["nodes"];
      }
    }
  ...
  var BACKGROUND = function (node, styleString)
  {
    var nodeStyle = window.getComputedStyle(node, null);
    var color = nodeStyle.getPropertyValue('background-color');
    return color;
  }
  var TEXT_ALIGN = function (node, styleString)
  {
    var nodeStyle = window.getComputedStyle(node, null);
    var align = nodeStyle.getPropertyValue('text-align');
    if ("start" === align)
      return null;
    return align;
  };
...
(function()
{
  ...
  ThematicMapRenderer.prototype.ResetComponentOptions = function (amxNode, attributeChanges, descendentChanges)
  {
    ...
    amxNode['_optionsObj']['areaLayers'].length = 0;
    delete amxNode['_optionsObj']['legend']['sections'];
    ...
    var callbackObject = 
    {
      'callback' : function (event, component)
      {
        ...
        if (type === DvtSelectionEvent.TYPE)
        {
          ...
          if (clientId)
          {
            itemNode = renderer.findAmxNodeById(amxNode, clientId);
...
(function(){
  ...
  TimelineRenderer.prototype.InitComponentOptions = function (amxNode)
  {
    ...
    amxNode['_optionsObj']['series'] = [];
    amxNode['_optionsObj']['minorAxis'] = {};
    amxNode['_optionsObj']['majorAxis'] = {};
        ...
        'callback' : function (event, component)
          {
            ...
            if (event.getType() === 'selection')
            {
              ...
              else
              {
                ...
                itemNode = renderer.findAmxNodeById(amxNode, lastSourceId);
              }
