...
public class CategoryList1 {
    ...
    public void getCategories1() {
        ...
        Category c=(Category)CategoryList.categories.get(Integer.parseInt(ct));
        ...
        ve62.setValue(AdfmfJavaUtilities.getAdfELContext(), categoryText1);
        ...
        vex2.refresh();
        //#{pageFlowScope.categoryDescription3}
        
        ValueExpression ve12 = AdfmfJavaUtilities.getValueExpression("#{pageFlowScope.categoryDescription1}", String.class);
