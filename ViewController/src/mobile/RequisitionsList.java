...
public class RequisitionsList {
    ...
    public Requisition[] getRequisitions() {
        Requisition e[] = null;
        e = (Requisition[])s_jobs.toArray(new Requisition[s_jobs.size()]);
        return e;
    }
    
    
    public void getRequisitionsList() {
        
        Requisition j = new Requisition(); 
        s_jobs.add(j);
